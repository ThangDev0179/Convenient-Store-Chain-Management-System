...
-- Fix Branch names
UPDATE dbo.Branch SET BranchName = N'Cửa hàng tiện lợi Quận 1' WHERE BranchId = 1;
UPDATE dbo.Branch SET BranchName = N'Chi nhánh Trung tâm' WHERE BranchId = 10;
UPDATE dbo.Branch SET BranchName = N'Chi nhánh Quận 2' WHERE BranchId = 11;
...
-- Fix Supplier names
UPDATE dbo.Supplier SET SupplierName = N'Công ty TNHH Nước Giải Khát Coca-Cola Việt Nam' WHERE SupplierId = 1;
UPDATE dbo.Supplier SET SupplierName = N'Công ty Cổ phần Acecook Việt Nam' WHERE SupplierId = 2;
UPDATE dbo.Supplier SET SupplierName = N'Công ty TNHH Suntory Pepsico Việt Nam' WHERE SupplierId = 3;
