...
public class RefundServiceImpl implements RefundService {
    ...
    private void writeIthRecord(Refund refund, RefundDetail detail,
        ...
        InventoryTransactionHistoryStub ith = InventoryTransactionHistoryStub.builder()
                ...
                .reason(reason)
                .createdBy(refund.getApprovedBy() != null ? refund.getApprovedBy() : refund.getRequestedBy())
                .createdAt(now)
                .build();
        ithRepo.save(ith);
    }
