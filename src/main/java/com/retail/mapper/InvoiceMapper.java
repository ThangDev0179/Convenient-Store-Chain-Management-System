 ...
 *   - sku, productName are joined from ProductStub (replace with real Product at full merge)
 */
@Component
public class InvoiceMapper {
     ...
     * productMap: productId → ProductStub (pre-fetched batch in service layer)
     */
    public InvoiceDetailResponse toDetailResponse(InvoiceDetail detail,
                                                   Map<Long, ProductStub> productMap) {
        ProductStub product = productMap.get(detail.getProductId());
